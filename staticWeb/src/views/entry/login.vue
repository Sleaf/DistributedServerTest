  ...
  <div class="container">
    <el-card class="box-card">
      <el-form class="loginFrom" :model="loginFrom" status-icon :rules="loginFromRule" ref="loginFrom">
        <div class="center">
          <div style="font-weight: bold;text-align: center;font-size: 1.5em">登录学力测</div>
        </div>
        ...
        <el-form-item class="submit-item">
          <el-button :loading="btn_loading" style="width: 100%" size="large" type="primary"
      ...
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.$.ajax.post(`/login`, JSON.stringify({
